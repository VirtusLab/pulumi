...
public class Cat extends io.pulumi.CustomResource {
    public io.pulumi.Output<java.util.Optional<String>> name;

    /**    * Create a Cat resource with the given name, arguments, and options.
    * @param name the unique name of the resource
    * @param args The arguments used to populate this resource's properties
    * @param options A bag of options that control this resource's behavior
    */
    public Cat(String name, CatArgs args, @javax.annotation.Nullable io.pulumi.CustomResourceOptions options) {
        super("example::Cat", name, args != null ? args : new CatArgs(), makeResourceOptions(options, io.pulumi.Input.create("")));
    }

    private Cat(String name, io.pulumi.Input<String> id, @javax.annotation.Nullable io.pulumi.CustomResourceOptions options) {
    ...
    * @param options A bag of options that control this resource's behavior.
    */
    public static Cat get(String name, @javax.annotation.Nullable String id, io.pulumi.CustomResourceOptions options) {
        return new Cat(name, io.pulumi.Input.create(id), options);
    }
}
