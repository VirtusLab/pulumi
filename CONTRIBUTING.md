...
```bash
brew install node pipenv python@3 typescript yarn go@1.13 openjdk@11 gradle golangci/tap/golangci-lint pulumi/tap/pulumictl
...
For contributors, we use the standard fork based workflow. Fork this repository, create a topic branch, and start hacking away.  When you're ready, make sure you've run the tests and open your PR.
