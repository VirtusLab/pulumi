...
public class Config {
    ...
    public Optional<String> get(String key) {
        ...
        return Deployment.getInstance().getInternal().getConfig(fullKey);
    }
    ...
    public <T> Optional<T> getObject(String key, Class<T> classOfT) {
        var v = get(key);
        try {
            return v.map(string -> new Gson().fromJson(string, classOfT));
     ...
     */
    private static class ConfigTypeException extends RuntimeException {
